package com.streetvendorhelper
...
import com.streetvendorhelper.util.VendorUtils
...
import com.streetvendorhelper.activity.EventDetailsActivity
import com.streetvendorhelper.activity.EventEditorActivity
import com.streetvendorhelper.activity.LocationActivity
...
*/
    ...
    private fun loadByLocation(lat: Double, long: Double){
        ...
        geoFire.queryAtLocation(currentGeoLocation, 100.0).addGeoQueryDataEventListener(object: GeoQueryDataEventListener {
